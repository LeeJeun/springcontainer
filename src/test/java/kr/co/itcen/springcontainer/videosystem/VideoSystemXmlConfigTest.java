...
public class VideoSystemXmlConfigTest {
	...
	@Test
	public void testDVD1Null() { // 얘네는 NULL 체크만 한다
		assertNotNull(dvd1);
	}
	...
	public void testDVD7Null() {
		...
		assertEquals("BlankDisc [title=Avengers Director's Edition, studio=MARVEL, actors=[Robert Downey, Chris Hemsworth, Chris Evans]]", systemOutRule.getLog().replace("\r\n", "").replace("\n", ""));
	}
	...
	public void testDVD8Null() {
		...
		assertEquals("BlankDisc [title=Avengers Expansion Pack, studio=MARVEL, actors=[Robert Downey, Chris Hemsworth, Chris Evans]]", systemOutRule.getLog().replace("\r\n", "").replace("\n", ""));
	}
	...
	public void testDVD9Null() {
		...
		assertEquals("BlankDisc [title=Avengers Expansion Pack2, studio=MARVEL, actors=[Robert Downey, Chris Hemsworth, Chris Evans]]", systemOutRule.getLog().replace("\r\n", "").replace("\n", ""));
	}
